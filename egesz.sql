...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CALENDARS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CALENDARS" 
   (	"CALENDAR_ID" NUMBER, 
	"USER_ID" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"COLOR" VARCHAR2(20 BYTE) DEFAULT '#3498db'
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CHILDLIBRARIES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CHILDLIBRARIES" 
   (	"CHILD_ID" NUMBER, 
	"LIBRARY_ID" NUMBER, 
	"CHILD_LIBRARY_ID" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "SYSTEM"."DEF$_CALLDEST" TO "SYS";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "SYSTEM"."DEF$_DESTINATION" TO "SYS";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "SYSTEM"."DEF$_ERROR" TO "SYS";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table DOCUMENTSHARES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."DOCUMENTSHARES" 
   (	"SHARE_ID" NUMBER, 
	"USER_ID" NUMBER, 
	"DOCUMENT_ID" NUMBER, 
	"PERMISSION" VARCHAR2(20 BYTE) DEFAULT 'read'
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."EVENTS" 
   (	"EVENT_ID" NUMBER, 
	...
	"IS_RECURRING" VARCHAR2(20 BYTE) DEFAULT 'FALSE'
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table LIBRARYSHARES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."LIBRARYSHARES" 
   (	"SHARE_ID" NUMBER, 
	"USER_ID" NUMBER, 
	"LIBRARY_ID" NUMBER, 
	"PERMISSION" VARCHAR2(20 BYTE) DEFAULT 'read'
...
--------------------------------------------------------
--  DDL for Table PARENTLIBRARIES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PARENTLIBRARIES" 
   (	"PARENT_ID" NUMBER, 
	"LIBRARY_ID" NUMBER, 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "SYSTEM"."REPCAT$_REPPROP" TO "SYS";
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "SYSTEM"."REPCAT$_REPSCHEMA" TO "SYS";
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9268867B77E053B6A9E80AB0C3','17406','AQ$_SCHEDULER$_EVENT_QTAB_E','17384','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9268877B77E053B6A9E80AB0C3','17407','SCHEDULER$_EVENT_QUEUE','17384','0','3','5','0','0','3600','Scheduler event queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9268897B77E053B6A9E80AB0C3','17440','AQ$_SCHEDULER$_REMDB_JOBQTAB_E','17411','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE92688A7B77E053B6A9E80AB0C3','17441','SCHEDULER$_REMDB_JOBQ','17411','0','3','5','0','0','0','Scheduler remote db job queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE92688C7B77E053B6A9E80AB0C3','17470','AQ$_SCHEDULER_FILEWATCHER_QT_E','17445','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE92688D7B77E053B6A9E80AB0C3','17471','SCHEDULER_FILEWATCHER_Q','17445','0','3','5','0','0','0','Scheduler file watcher results queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE92688E7B77E053B6A9E80AB0C3','17525','AQ$_ALERT_QT_E','17503','1','2','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE92688F7B77E053B6A9E80AB0C3','17526','ALERT_QUE','17503','0','3','5','0','0','0','Server Generated Alert Queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9268EC7B77E053B6A9E80AB0C3','17634','AQ$_KUPC$DATAPUMP_QUETAB_E','17587','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9269D87B77E053B6A9E80AB0C3','17956','AQ$_AQ$_MEM_MC_E','17932','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9269D97B77E053B6A9E80AB0C3','17957','SRVQUEUE','17932','2','3','0','0','0','0',null,null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9269DA7B77E053B6A9E80AB0C3','17968','AQ$_AQ_EVENT_TABLE_E','17958','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9269DB7B77E053B6A9E80AB0C3','17969','AQ_EVENT_TABLE_Q','17958','0','3','5','0','0','0','CREATING AQ_EVENT_TABLE_Q QUEUE',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9269DC7B77E053B6A9E80AB0C3','17992','AQ$_AQ_PROP_TABLE_E','17970','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9269DD7B77E053B6A9E80AB0C3','17993','AQ_PROP_NOTIFY','17970','0','3','5','0','0','0','Queue for Notifying events in AQ Prop. Scheduling',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE926AF97B77E053B6A9E80AB0C3','18246','AQ$_DEF$_AQCALL_E','18238','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE926AFA7B77E053B6A9E80AB0C3','18247','DEF$_AQCALL','18238','0','3','5','0','1','0','Deferred RPC Queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE926AFB7B77E053B6A9E80AB0C3','18257','AQ$_DEF$_AQERROR_E','18249','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE926AFC7B77E053B6A9E80AB0C3','18258','DEF$_AQERROR','18249','0','3','5','0','1','0','Error Queue for Deferred RPCs',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE926B0C7B77E053B6A9E80AB0C3','18299','AQ$_SYS$SERVICE_METRICS_TAB_E','18277','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE926B0D7B77E053B6A9E80AB0C3','18300','SYS$SERVICE_METRICS','18277','0','3','5','0','0','3600',null,null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9278677B77E053B6A9E80AB0C3','19736','AQ$_CHANGE_LOG_QUEUE_TABLE_E','19714','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A39EE9278687B77E053B6A9E80AB0C3','19737','CHANGE_LOG_QUEUE','19714','0','3','5','0','0','0','GSM Change Log Queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A3A497FF98E26DCE053B6A9E80AEE54','19954','AQ$_WM$EVENT_QUEUE_TABLE_E','19927','1','0','0','0','0','0','exception queue',null,null,null,null,null,'0');
Insert into SYSTEM.AQ$_QUEUES (OID,EVENTID,NAME,TABLE_OBJNO,USAGE,ENABLE_FLAG,MAX_RETRIES,RETRY_DELAY,PROPERTIES,RET_TIME,QUEUE_COMMENT,SUBSCRIBERS,MEMORY_THRESHOLD,SERVICE_NAME,NETWORK_NAME,SUB_OID,SHARDED) values ('1A3A497FF98F26DCE053B6A9E80AEE54','19955','WM$EVENT_QUEUE','19927','0','3','5','0','0','0','OWM Events Queue',null,null,null,null,null,'0');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.CALENDARS
SET DEFINE OFF;
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('15','12','15','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('16','13','16','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('17','14','17','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('18','15','18','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('19','16','19','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('20','17','20','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('21','18','21','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('13','10','13','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('14','11','14','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('22','19','22','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('23','20','23','#6EC1F4');
Insert into SYSTEM.CALENDARS (CALENDAR_ID,USER_ID,NAME,COLOR) values ('24','21','24','#6EC1F4');
REM INSERTING into SYSTEM.CHILDLIBRARIES
SET DEFINE OFF;
Insert into SYSTEM.CHILDLIBRARIES (CHILD_ID,LIBRARY_ID,CHILD_LIBRARY_ID) values ('1','3','4');
Insert into SYSTEM.CHILDLIBRARIES (CHILD_ID,LIBRARY_ID,CHILD_LIBRARY_ID) values ('2','5','6');
Insert into SYSTEM.CHILDLIBRARIES (CHILD_ID,LIBRARY_ID,CHILD_LIBRARY_ID) values ('3','8','9');
Insert into SYSTEM.CHILDLIBRARIES (CHILD_ID,LIBRARY_ID,CHILD_LIBRARY_ID) values ('4','8','10');
Insert into SYSTEM.CHILDLIBRARIES (CHILD_ID,LIBRARY_ID,CHILD_LIBRARY_ID) values ('5','8','11');
Insert into SYSTEM.CHILDLIBRARIES (CHILD_ID,LIBRARY_ID,CHILD_LIBRARY_ID) values ('6','18','19');
Insert into SYSTEM.CHILDLIBRARIES (CHILD_ID,LIBRARY_ID,CHILD_LIBRARY_ID) values ('7','18','20');
Insert into SYSTEM.CHILDLIBRARIES (CHILD_ID,LIBRARY_ID,CHILD_LIBRARY_ID) values ('8','18','21');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.DOCUMENTS
SET DEFINE OFF;
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('4','10','4','tajkep_vilagos.jpg','uploads/user_10/6828f999b781a_tajkep_vilagos.jpg','image/jpeg','81088',to_timestamp('25-MÁJ.  -17 23.03.21,765551000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.03.21,765551000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('6','11','6','kisc.jpeg','uploads/user_11/6828fb2b7d75c_kisc.jpeg','image/jpeg','5221',to_timestamp('25-MÁJ.  -17 23.10.03,519150000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.10.03,519150000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('7','11','5','maine.jpeg','uploads/user_11/6828fb39583aa_maine.jpeg','image/jpeg','6483',to_timestamp('25-MÁJ.  -17 23.10.17,363970000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.10.17,363970000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('5','10',null,'tarsasjatek.jpg','uploads/user_10/6828f9b1f203d_tarsasjatek.jpg','image/jpeg','123747',to_timestamp('25-MÁJ.  -17 23.03.45,995478000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.03.45,995478000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('8','11',null,'tarsasjatek_2.jpg','uploads/user_11/6828fbd9c0906_tarsasjatek_2.jpg','image/jpeg','74491',to_timestamp('25-MÁJ.  -17 23.12.57,794936000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.12.57,794936000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('9','12',null,'utcakep_sotet_2.jpg','uploads/user_12/6828fd20ddb0e_utcakep_sotet_2.jpg','image/jpeg','103133',to_timestamp('25-MÁJ.  -17 23.18.24,911701000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.18.24,911701000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('10','12','7','delfin.jpg','uploads/user_12/6828fd610290d_delfin.jpg','image/jpeg','68232',to_timestamp('25-MÁJ.  -17 23.19.29,013968000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.19.29,013968000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('11','12','7','delfin2.jpg','uploads/user_12/6828fd66e4c92_delfin2.jpg','image/jpeg','46509',to_timestamp('25-MÁJ.  -17 23.19.34,941114000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.19.34,941114000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('12','13','11','gyakorlat02.pdf','uploads/user_13/68290108b8cb2_gyakorlat02.pdf','application/pdf','527990',to_timestamp('25-MÁJ.  -17 23.35.04,761155000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.35.04,761155000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('13','14','12','tajkep_vilagos.jpg','uploads/user_14/682903cb07c12_tajkep_vilagos.jpg','image/jpeg','81088',to_timestamp('25-MÁJ.  -17 23.46.51,036539000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.46.51,036539000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('14','14','12','utcakep_sotet_2.jpg','uploads/user_14/682903d3b8263_utcakep_sotet_2.jpg','image/jpeg','103133',to_timestamp('25-MÁJ.  -17 23.46.59,757971000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.46.59,757971000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('15','15',null,'tarsasjatek_2.jpg','uploads/user_15/6829066f9b0e6_tarsasjatek_2.jpg','image/jpeg','74491',to_timestamp('25-MÁJ.  -17 23.58.07,641545000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -17 23.58.07,641545000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('16','15','13','konyv.jpg','uploads/user_15/6829076932d51_konyv.jpg','image/jpeg','83966',to_timestamp('25-MÁJ.  -18 00.02.17,210458000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.02.17,210458000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('17','17','14','lol.jpeg','uploads/user_17/68290b9c06bd8_lol.jpeg','image/jpeg','7387',to_timestamp('25-MÁJ.  -18 00.20.12,030470000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.20.12,030470000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('18','17','15','cavalier.jpg','uploads/user_17/68290c45af5a8_cavalier.jpg','image/jpeg','103151',to_timestamp('25-MÁJ.  -18 00.23.01,720454000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.23.01,720454000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('19','18','17','tiara.jpg','uploads/user_18/68290d884ae25_tiara.jpg','image/jpeg','37951',to_timestamp('25-MÁJ.  -18 00.28.24,308920000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.28.24,308920000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('20','19','19','kisc.jpeg','uploads/user_19/68291381eec30_kisc.jpeg','image/jpeg','5221',to_timestamp('25-MÁJ.  -18 00.53.53,981179000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.53.53,981179000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('21','19','19','maine.jpeg','uploads/user_19/68291388f2fad_maine.jpeg','image/jpeg','6483',to_timestamp('25-MÁJ.  -18 00.54.00,997312000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.54.00,997312000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('22','19','20','delfin2.jpg','uploads/user_19/6829139677003_delfin2.jpg','image/jpeg','46509',to_timestamp('25-MÁJ.  -18 00.54.14,489599000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.54.14,489599000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('23','19','20','delfin.jpg','uploads/user_19/6829139c217aa_delfin.jpg','image/jpeg','68232',to_timestamp('25-MÁJ.  -18 00.54.20,138612000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.54.20,138612000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('24','19','21','cavalier.jpg','uploads/user_19/682913a52f9e3_cavalier.jpg','image/jpeg','103151',to_timestamp('25-MÁJ.  -18 00.54.29,197258000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 00.54.29,197258000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('25','20','22','alma.txt','uploads/user_20/6829167daa61a_alma.txt','text/plain','0',to_timestamp('25-MÁJ.  -18 01.06.37,702944000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 01.06.37,702944000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('26','20','22','tiara.jpg','uploads/user_20/682917c7cb63d_tiara.jpg','image/jpeg','37951',to_timestamp('25-MÁJ.  -18 01.12.07,835997000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 01.12.07,835997000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('27','21','23','alma.txt','uploads/user_21/68291865c0f66_alma.txt','text/plain','0',to_timestamp('25-MÁJ.  -18 01.14.45,791628000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 01.14.45,791628000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('28','21','24','tarsasjatek.jpg','uploads/user_21/6829189c82e63_tarsasjatek.jpg','image/jpeg','123747',to_timestamp('25-MÁJ.  -18 01.15.40,538716000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 01.15.40,538716000','RR-MON-DD HH24.MI.SSXFF'));
Insert into SYSTEM.DOCUMENTS (DOCUMENT_ID,USER_ID,LIBRARY_ID,NAME,FILE_PATH,FILE_TYPE,FILE_SIZE,CREATED_AT,UPDATED_AT) values ('29','21','24','tarsasjatek_2.jpg','uploads/user_21/682918a1db7f8_tarsasjatek_2.jpg','image/jpeg','74491',to_timestamp('25-MÁJ.  -18 01.15.45,901180000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -18 01.15.45,901180000','RR-MON-DD HH24.MI.SSXFF'));
REM INSERTING into SYSTEM.DOCUMENTSHARES
SET DEFINE OFF;
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('26','13','14','read');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('27','14','15','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('10','10','8','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('25','10','14','read');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('28','11','16','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('30','12','15','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('31','11','15','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('33','10','17','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('34','11','17','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('35','14','17','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('37','15','19','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('38','11','19','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('42','19','25','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('43','17','25','edit');
Insert into SYSTEM.DOCUMENTSHARES (SHARE_ID,USER_ID,DOCUMENT_ID,PERMISSION) values ('44','10','25','edit');
REM INSERTING into SYSTEM.EVENTS
SET DEFINE OFF;
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('29','11','14','Vacsora a csaladdal',to_timestamp('25-MÁJ.  -22 20.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -22 23.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'otthon','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('30','12','15','Delfin nezes',to_timestamp('25-AUG.  -04 05.20.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-AUG.  -06 23.20.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'ocean','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('31','13','16','Alga vizsga',to_timestamp('25-JÚN.  -12 10.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -12 11.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Irinyi epulet','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('32','13','16','Prog vizsga',to_timestamp('25-MÁJ.  -30 10.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -30 11.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Irinyi epulet','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('33','13','16','Vazkijeloles vizsga',to_timestamp('25-MÁJ.  -27 08.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -27 09.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Irinyi epulet','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('27','10','13','Sasnezes',to_timestamp('25-MÁJ.  -21 10.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -22 16.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Hegy','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('34','13','16','Alkfejl vizsga',to_timestamp('25-JÚN.  -10 13.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -10 14.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Irinyi epulet','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('28','10','13','Almaszedes',to_timestamp('25-JÚN.  -02 05.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -02 20.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Gyumolcsos','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('35','13','16','Terinfo vizsga',to_timestamp('25-MÁJ.  -28 09.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -28 10.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Irinyi epulet','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('36','13','16','Hardveres vizsga',to_timestamp('25-JÚN.  -20 14.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -20 15.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Irinyi epulet','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('37','13','16','mobilalk vizsga',to_timestamp('25-JÚN.  -19 10.45.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -19 11.45.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Irinyi epulet','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('38','14','17','valami vizsga',to_timestamp('25-MÁJ.  -28 08.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -28 09.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Irinyi epulet','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('39','14','17','Szulinap',to_timestamp('25-MÁJ.  -24 20.40.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -25 03.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Karcsinal','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('40','14','17','Buli',to_timestamp('25-MÁJ.  -31 20.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -01 04.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Feconal','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('41','15','18','Randi ',to_timestamp('25-MÁJ.  -24 19.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -25 19.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'NEMTUDOOOM hehe','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('42','15','18','Lillaekkal taliii',to_timestamp('25-MÁJ.  -21 15.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -21 19.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'kavezo','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('43','15','18','Tabor',to_timestamp('25-JÚN.  -02 00.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -08 00.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'valami hegy','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('44','16','19','Kavezas',to_timestamp('25-MÁJ.  -19 04.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -19 10.59.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Erikanal','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('45','16','19','Idegesiteni a buszozokat a jelenletemmel',to_timestamp('25-MÁJ.  -20 06.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -20 09.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'busz','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('46','16','19','Unokaimra vigyazni',to_timestamp('25-MÁJ.  -21 13.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -21 19.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'otthon','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('47','16','19','Vasarnapi ebed',to_timestamp('25-MÁJ.  -11 10.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -11 13.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'otthon','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('48','16','19','Vasarolni',to_timestamp('25-MÁJ.  -23 13.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -23 15.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Nagy tesco','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('50','17','20','jatszani',to_timestamp('25-MÁJ.  -18 20.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -19 03.16.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'otthon','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('51','17','20','ivas',to_timestamp('25-MÁJ.  -31 21.17.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -01 02.17.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Nalam','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('52','17','20','Szulinap',to_timestamp('25-JÚN.  -07 18.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -07 21.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'otthon','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('53','18','21','Jatszani',to_timestamp('25-MÁJ.  -24 13.25.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -24 17.25.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'a szobam','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('54','18','21','teazas',to_timestamp('25-MÁJ.  -23 14.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -23 17.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'szobaam','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('55','18','21','Mamahoz menni',to_timestamp('25-MÁJ.  -26 13.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -26 18.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'mamanal','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('58','19','22','hugomidegesitese',to_timestamp('25-MÁJ.  -23 07.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -23 07.05.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'hugom szobaja','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('60','19','22','tanulas',to_timestamp('25-MÁJ.  -26 12.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -26 17.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'TIK','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('61','19','22','Ebed ',to_timestamp('25-MÁJ.  -11 10.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -11 13.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'nagyinal','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('62','19','22','tanulas',to_timestamp('25-JÚN.  -03 12.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -03 17.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'TIK','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('63','19','22','kirandulas',to_timestamp('25-MÁJ.  -03 05.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -04 21.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Bakony','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('64','20','23','Titok',to_timestamp('25-MÁJ.  -18 20.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -19 01.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'etterem','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('65','20','23','Piknik',to_timestamp('25-MÁJ.  -31 16.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -31 19.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Margit sziget','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('66','20','23','Lanykeres',to_timestamp('25-JÚN.  -07 20.05.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-JÚN.  -08 01.05.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Etterem','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('67','21','24','Pletykaparti',to_timestamp('25-MÁJ.  -03 14.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -03 17.15.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'Nalam','FALSE');
Insert into SYSTEM.EVENTS (EVENT_ID,USER_ID,CALENDAR_ID,TITLE,START_TIME,END_TIME,LOCATION,IS_RECURRING) values ('68','21','24','Ebed',to_timestamp('25-MÁJ.  -25 11.30.00,000000000','RR-MON-DD HH24.MI.SSXFF'),to_timestamp('25-MÁJ.  -25 12.00.00,000000000','RR-MON-DD HH24.MI.SSXFF'),'ebedlo','FALSE');
...
REM INSERTING into SYSTEM.LIBRARIES
SET DEFINE OFF;
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('5','11','Cicakepek');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('6','11','kiscicak');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('3','10','Elso mappa');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('4','10','Tarolo');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('7','12','delfinek');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('8','13','4.felev');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('9','13','vazkijeloles');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('10','13','alkfejl');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('11','13','alga');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('12','14','tajkepek');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('13','15','idezetek');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('14','17','lol');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('15','17','alomkutya');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('16','17','farm');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('17','18','tiarak');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('18','19','allatok');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('19','19','cicak');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('20','19','delfinek');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('21','19','kutyak');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('22','20','Ajandek');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('23','21','Alma');
Insert into SYSTEM.LIBRARIES (LIBRARY_ID,USER_ID,NAME) values ('24','21','Karacsonyiajandekok');
REM INSERTING into SYSTEM.LIBRARYSHARES
SET DEFINE OFF;
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('13','12','8','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('14','12','11','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('11','10','7','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('12','11','7','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('15','12','10','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('16','12','9','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('17','11','8','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('18','11','11','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('19','11','10','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('20','11','9','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('21','10','8','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('22','10','11','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('23','10','10','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('24','10','9','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('29','14','13','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('32','13','14','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('36','16','17','read');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('39','13','19','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('40','17','20','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('41','18','21','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('45','12','22','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('46','15','22','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('47','13','22','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('48','11','22','edit');
Insert into SYSTEM.LIBRARYSHARES (SHARE_ID,USER_ID,LIBRARY_ID,PERMISSION) values ('49','16','22','edit');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PARENTLIBRARIES
SET DEFINE OFF;
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('43','5',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('44','6','5');
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('41','3',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('42','4','3');
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('45','7',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('46','8',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('47','9','8');
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('48','10','8');
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('49','11','8');
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('50','12',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('51','13',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('52','14',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('53','15',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('54','16',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('55','17',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('56','18',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('57','19','18');
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('58','20','18');
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('59','21','18');
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('60','22',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('61','23',null);
Insert into SYSTEM.PARENTLIBRARIES (PARENT_ID,LIBRARY_ID,PARENT_LIBRARY_ID) values ('62','24',null);
...
SET DEFINE OFF;
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('11','cicoka','cico31@haloo.jo','$2y$10$SrwUYiZVtGpVdqdSuPSYEeJRT.vMiUEYm3riCA/RxyKuvrhnk9KZC','uploads/user_11/profile_picture/profile_1747516615.jpeg');
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('12','Delfin','delfing67@haloo.jo','$2y$10$9kJ50zbgzS5be8EkKXo/OuLVxSu4yfz9movgdcu9cfoWdK73d5Tmq','uploads/user_12/profile_picture/profile_1747517011.jpg');
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('13','Liza33','Lizacska33@haloo.jo','$2y$10$pGtXI9SxBreJ1MSpWbVCsOcsINw84rFDC/bTPcgOib6sflW.F2Bx.',null);
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('14','Laszlovok','laszloo@haloo.jo','$2y$10$XRgn0dAKnUa9Gb3U6n5YeeDAovmykizWfFU3wP.RQ5fm2S5hjgUMu',null);
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('15','user45','hajnika45@haloo.jo','$2y$10$ntIeSs9O3o13dWxT33XhvOFZGcwn3S/JW5FCcBpTGaWuUyPr0ZJga',null);
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('10','kiskutya01','kutyus@haloo.jo','$2y$10$IGa3v0RUZrp4GJovUWNl3eW6ZZHC3cx3X5GOww7LArHdrOrqZpcp6','uploads/user_10/profile_picture/profile_1747516043.jpg');
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('16','Rozsika','rozsi67@haloo.jo','$2y$10$Bts.rgXZIExjId4ftSLJ7OAg8GFSKGjKAXqRynaw0GoFsBn.lVnBa','uploads/user_16/profile_picture/profile_1747519827.jpeg');
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('17','Pali','pali99@haloo.jo','$2y$10$sBOPShWFov45OF086RJ3h.1T8tu0FfEfT5/AywvieduyKSv/AyIeq',null);
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('18','hercegno11','hercegnovo@haloo.jo','$2y$10$H8dVs5mqLsPU46Ag0LckduEtGOfhrPWbj1PPso.IKMzduztjdm/ci',null);
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('19','Annus37','annu37@haloo.jo','$2y$10$3sMHSD18vK1foisSjrJdEezU8kzQglBZE3zqbQ6ywK6NV8jVSWS7a',null);
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('20','user11','user11@gmail.com','$2y$10$E2WnAcPBxPLAeXpCfp26..eIHB1C1NtlxYbTfRx24AQ3rcrDQL5hu',null);
Insert into SYSTEM.USERS (USER_ID,USERNAME,EMAIL,PASSWORD,PROFILE_PICTURE) values ('21','Marika','Maris@haloo.jo','$2y$10$2F4e8kxFv1wEhNePxYRH.OQreOXQlQZm7VMqKE4J8PUWOc0/WOLje',null);
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger NAPTAR
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."NAPTAR" 
...
END;
/
ALTER TRIGGER "SYSTEM"."NAPTAR" ENABLE;
--------------------------------------------------------
