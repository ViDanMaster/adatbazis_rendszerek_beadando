...
$currentShares = getDocumentShares($documentId);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['share'])) {
        ...
        if ($sharedUserId && in_array($permission, ['read', 'edit'])) {
            if (shareDocument($documentId, $sharedUserId, $permission)) {
                $message = '<div class="success-message">Dokumentum sikeresen megosztva!</div>';
                $success = true;
                $currentShares = getDocumentShares($documentId);
            } else {
        ...
        if (removeDocumentShare($documentId, $userId)) {
        ...
        if (in_array($newPermission, ['read', 'edit'])) {
            if (shareDocument($documentId, $userId, $newPermission)) {
...
<head>
  ...
  <title>Dokumentum megosztása - Goofle</title>
...
<body>
  ...
  <div class="main-content">
    <div class="breadcrumbs">
      ...
      &gt; <a href="document.php?id=<?php echo $documentId; ?>"><?php echo htmlspecialchars($document['NAME']); ?></a>
      &gt; <span>Megosztás</span>
    </div>
    
    <h1>Dokumentum megosztása: <?php echo htmlspecialchars($document['NAME']); ?></h1>
    ...
    <div class="form-container">
      <form method="post" action="">
        ...
        <div class="form-actions">
          <a href="document.php?id=<?php echo $documentId; ?>" class="btn-secondary">Mégse</a>
