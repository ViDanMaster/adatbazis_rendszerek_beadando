<nav class="navbar">
  ...
  <ul>
    ...
    <li><a href="calendar.php" <?php echo basename($_SERVER['PHP_SELF']) == 'calendar.php' ? 'class="active"' : ''; ?>>Naptáraim</a></li>
    <li><a href="add_calendar.php" <?php echo basename($_SERVER['PHP_SELF']) == 'add_calendar.php' ? 'class="active"' : ''; ?>>Új naptár</a></li>
  </ul>
</nav>